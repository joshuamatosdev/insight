...
function resolveVariant(variant?: LegacyVariant): { color?: keyof typeof styles.colors; outline?: boolean; plain?: boolean } {
...
export const Button = forwardRef(function Button(
  { color, outline, plain, variant, size, fullWidth, className, children, href, isDisabled, isLoading, leftIcon, disabled, ...props }: ButtonProps,
  ...
  const buttonContent = (
    <>
      {isLoading === true && (
        <svg className="animate-spin -ml-1 mr-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" data-slot="icon">
  ...
  return href !== undefined ? (
    <Link {...(props as React.ComponentPropsWithoutRef<typeof Link>)} href={href} className={classes} ref={ref as React.ForwardedRef<HTMLAnchorElement>}>

// Tailwind Plus UI Blocks - Checkout Pages
      ...
      <main className="lg:flex lg:min-h-full lg:flex-row-reverse lg:overflow-hidden">
        ...
        >
          <div className="mx-auto max-w-lg">
            ...
            <form className="mt-6">
              <Grid columns={12} gap="md" className="gap-y-6">
...
// =============================================================================
// 2. Single step with order summary
// =============================================================================
'use client'
              ...
              <TabPanels as={Fragment}>
                {navigation.categories.map((category) => (
                  <TabPanel key={category.name} className="space-y-12 px-4 py-6">
                    <Grid columns={2} gap="md" className="gap-y-10">
                          ...
                          >
                            ...
                            <div className="relative bg-white">
                              <div className="mx-auto max-w-7xl px-8">
                                <Grid columns={4} gap="xl" className="gap-y-10 py-16">
                                  {category.featured.map((item) => (
                                    <div key={item.name} className="group relative">
                                      <img
                                        alt={item.imageAlt}
            ...
            <div>
              ...
              <div className="mt-10 border-t border-gray-200 pt-10">
                ...
                <fieldset aria-label="Delivery method" className="mt-4">
                  <Grid columns={1} gap="lg" className="sm:grid-cols-2 sm:gap-x-4">
              ...
              <div className="mt-10 border-t border-gray-200 pt-10">
                ...
                <Grid columns={4} gap="md" className="mt-6 gap-y-6">
...
// =============================================================================
// 3. With mobile order summary overlay
// =============================================================================
        ...
        <form className="px-4 pt-16 pb-36 sm:px-6 lg:col-start-1 lg:row-start-1 lg:px-0 lg:pb-16">
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <section aria-labelledby="payment-heading" className="mt-10">
              ...
              <Grid columns={3} gap="md" className="mt-6 gap-y-6 sm:grid-cols-4">
            ...
            <section aria-labelledby="shipping-heading" className="mt-10">
              ...
              <Grid columns={1} gap="md" className="mt-6 gap-y-6 sm:grid-cols-3">

// Tailwind Plus UI Blocks - Banners
...
// 1. With button (Light)
// =============================================================================
export function BannerWithButtonLight() {
  return (
    <Flex align="center" gap="lg" className="relative isolate overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <Box
        aria-hidden="true"
      ...
      <Flex wrap="wrap" align="center" className="gap-x-4 gap-y-2">
...
// 2. With button (Dark)
// =============================================================================
export function BannerWithButtonDark() {
  return (
    <Flex align="center" gap="lg" className="relative isolate overflow-hidden bg-gray-800/50 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
      <Box
        aria-hidden="true"
        className="absolute top-1/2 left-[max(-7rem,calc(50%-52rem))] -z-10 -translate-y-1/2 transform-gpu blur-2xl"
      >
...
export default BannerWithButtonLight

...
import type {DataSource, MapFiltersProps, SetAsideType} from './Map.types';
        ...
        <Box className={clsx('rounded-lg border border-outline-variant bg-surface-container p-4', className)}>
            <Flex direction="column" gap="md">
                ...
                <Flex direction="column" gap="sm">
                    {/* Data Source */}
                    <Box>
                        <Text as="label" htmlFor="data-source-filter"
                    ...
                    {/* Set-Aside */}
                    <Box>
                        <Text as="label" htmlFor="set-aside-filter"
                              className="mb-1 block text-xs text-on-surface-variant">
                            Set-Aside
                        </Text>
                        <select
                    ...
                    {availableNaics.length > 0 && (
                        <Box>
                            <Text as="label" htmlFor="naics-filter"
                                  className="mb-1 block text-xs text-on-surface-variant">
                                NAICS Code
                            </Text>
                            <select
                    ...
                    {availableAgencies.length > 0 && (
                        <Box>
                            <Text as="label" htmlFor="agency-filter"
                                  className="mb-1 block text-xs text-on-surface-variant">
                                Agency
                            </Text>
                            <select
